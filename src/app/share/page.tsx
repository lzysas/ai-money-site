  ...
  twitter: [
    {
      ...
      text: "Get 40 professional AI headshots for $19. No photographer needed. Upload selfies, get LinkedIn-ready photos in 3 minutes. https://ai-money-site.vercel.app/landing #AI #Headshots #LinkedIn",
    },
    {
    ...
    },
    {
      ...
      text: "Need blog posts that rank on Google? Our AI writes 2,000+ word SEO-optimized articles in 30 seconds. Meta tags, keywords, perfect structure. $29 per article. https://ai-money-site.vercel.app/seo",
    },
  ],
  facebook: [
    {
      title: "Product Launch Post",
      text: "Professional AI Headshots - Only $19! Get 40 stunning LinkedIn-ready headshots without hiring a photographer. Try it now: https://ai-money-site.vercel.app/landing PayPal accepted. Instant delivery. 7-day money-back guarantee.",
    },
    {
      title: "Before/After Post Idea",
      text: "From selfie to professional headshot in 3 minutes! Our AI transforms your casual photos into studio-quality headshots. 100+ styles, instant download. Only $19: https://ai-money-site.vercel.app/checkout?product=headshots&amount=19 Share with a friend who needs a new LinkedIn photo!",
    },
  ],
  reddit: [
    {
      title: "r/sidehustle",
      text: "How I Built a $1K/Month AI Headshot Side Hustle (Zero Skills Required). I wanted to share my experience selling AI-generated headshots online. Here is the breakdown: Setup took 1 hour using the platform. Marketing is just posting on LinkedIn and Twitter. The AI handles all generation automatically. I collect payments via PayPal. Revenue: $19 per customer, about 2-3 sales per day. Happy to answer questions! https://ai-money-site.vercel.app",
    },
    {
      title: "r/LinkedIn",
      text: "PSA: You can now get professional headshots for $19 using AI. I was skeptical but tried it and got 40 incredible headshots in 3 minutes. They look better than the $300 photographer I used last year. Sharing because everyone on LinkedIn needs a great profile photo. https://ai-money-site.vercel.app/landing",
    },
  ],
  linkedin: [
    {
      title: "Professional Post",
      text: "Your LinkedIn photo is your first impression. Studies show profiles with professional headshots get 14x more views. But professional photographers charge $200-$500. I found a solution: AI-generated headshots for just $19. Upload a few selfies, get 40 professional headshots in 3 minutes. I tried it myself and the results are incredible. Check it out: https://ai-money-site.vercel.app/landing",
    },
  ],
};
    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="mb-12 p-6 bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl border border-purple-200 text-center">
        ...
        <div className="text-lg font-mono bg-white rounded-xl p-3 inline-block mb-2">
          https://ai-money-site.vercel.app
        </div>
